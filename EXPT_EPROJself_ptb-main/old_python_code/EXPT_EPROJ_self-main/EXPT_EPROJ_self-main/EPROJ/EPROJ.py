...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/luria/Downloads/EPROJ_Presentation_Code/EPROJ/EPROJ.py',
...
settings = {
  ...
  'sync': 'num_add' or '1', # character to use as the sync timing event; assumed to come at start of a volume
